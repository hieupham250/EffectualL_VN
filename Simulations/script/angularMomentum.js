...
class BasicWorldDemo {
  ...
  _OnStop(msg) {
    console.log("this.isStop", this.isStop, this.isLinear);
    if (this.isStop) {
      stopButton.innerHTML = i18next.t("start");
    } else {
      stopButton.innerHTML = i18next.t("stop");
    }
  ...
  _OnLinear(msg) {
    console.log("this.isStop", this.isStop, this.isLinear);
    if (!this.isLinear) {
      linearButton.innerHTML = i18next.t("circular motion");
      messageEl.innerHTML = i18next.t("car_moving_circular");
    } else {
      linearButton.innerHTML = i18next.t("Linear motion");
      messageEl.innerHTML = i18next.t("car_moving_linear");
    }
